...
import (
	...
	"kubebuilder-ingress/controllers/utils"
	...
	ingressv1beta1 "kubebuilder-ingress/api/v1beta1"
)
...
//+kubebuilder:rbac:groups=ingress.zhiyuanzhou.cloud,resources=apps,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=ingress.zhiyuanzhou.cloud,resources=apps/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=ingress.zhiyuanzhou.cloud,resources=apps/finalizers,verbs=update
